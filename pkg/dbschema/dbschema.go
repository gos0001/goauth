// Package dbschema applies goauth's table definitions at startup.
//
...
// missing and leaves alone what exists. For a service whose schema is three
// tables, that is the whole requirement.
//
...
// service.
const schemaLockKey int64 = 0x676F61757468 // "goauth" in hex
...
// omits and which is the only thing that makes a syntax error in a 60-line
// schema findable.
